...
export function Logo({ width = 48, height = 48, className = "", variant = "full", showText = false }: LogoProps) {
  ...
  const imageUrl =
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Adobe%20Express%20-%20file-HcjnXFMgDvMkdXpZjaJB4D1wiaY9C4.png"
  ...
  const FallbackLogo = () => (
    ...
    >
      ...
      {/* Shield shape */}
      <path d="M24 4L8 12V24C8 32 16 40 24 44C32 40 40 32 40 24V12L24 4Z" fill="#0A2559" />
      ...
      {/* Orange stripes */}
      <rect x="8" y="16" width="6" height="2" fill="#FF5722" />
      <rect x="34" y="16" width="6" height="2" fill="#FF5722" />
      <rect x="8" y="20" width="6" height="2" fill="#FF5722" />
      <rect x="34" y="20" width="6" height="2" fill="#FF5722" />
    </svg>
  )
