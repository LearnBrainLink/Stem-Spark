    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link href="#about" className="text-gray-600 hover:text-[#0A2559] transition-colors">
              About
            </Link>
            <Link href="#resources" className="text-gray-600 hover:text-[#0A2559] transition-colors">
              Resources
            </Link>
            <Link href="#impact" className="text-gray-600 hover:text-[#0A2559] transition-colors">
              Impact
            </Link>
            <Link href="/login">
              <Button className="bg-[#0A2559] hover:bg-[#1a365d] text-white">Get Started Free</Button>
            </Link>
          </nav>
        </div>
      </header>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-6xl">
          <Badge className="mb-6 bg-gradient-to-r from-blue-100 to-purple-100 text-[#0A2559] border-blue-200">
            Free for All Students • Grades 5-8
          </Badge>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-[#0A2559] to-[#FF5722] bg-clip-text text-transparent leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Link href="/login">
              <Button size="lg" className="bg-[#0A2559] hover:bg-[#1a365d] text-white text-lg px-8 py-4">
            ...
            <Link href="/videos">
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-8 py-4 border-2 border-[#0A2559] text-[#0A2559]"
              >
          ...
          {/* Hero Image with STEM Spark Academy branding */}
          <div className="relative max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-[#0A2559] to-[#1a365d] rounded-2xl p-8 shadow-2xl">
              <BrandedImage
            ...
            {/* Floating elements */}
            <div className="absolute -top-4 -left-4 bg-[#FF5722] rounded-full p-3 shadow-lg animate-bounce">
              <Lightbulb className="w-6 h-6 text-white" />
            </div>
            <div className="absolute -top-4 -right-4 bg-[#0A2559] rounded-full p-3 shadow-lg animate-bounce delay-300">
      ...
      <section id="about" className="py-20 bg-white/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#0A2559] to-[#FF5722] bg-clip-text text-transparent">
              Our Mission
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-blue-50 to-blue-100">
              <CardContent className="p-8 text-center">
                <div className="w-16 h-16 bg-[#0A2559] rounded-full flex items-center justify-center mx-auto mb-6">
                  <Users className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-2xl font-bold mb-4 text-[#0A2559]">Accessible to All</h3>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-purple-50 to-purple-100">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold mb-4 text-[#0A2559]">Hands-On Learning</h3>
                <p className="text-gray-600">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-pink-50 to-pink-100">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold mb-4 text-[#0A2559]">Grade 5-8 Focus</h3>
                <p className="text-gray-600">
      ...
      {/* Features Section with branded images */}
      <section id="resources" className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#0A2559] to-[#FF5722] bg-clip-text text-transparent">
            ...
            <div>
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-[#0A2559]">100% Free Resources</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-[#0A2559] rounded-lg flex items-center justify-center flex-shrink-0">
                    <Lightbulb className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-[#0A2559]">Project-Based Learning</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-[#0A2559]">Inclusive Design</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-[#0A2559]">Future-Ready Skills</h3>
                    <p className="text-gray-600">
      ...
      {/* Impact Section */}
      <section id="impact" className="py-20 bg-[#0A2559] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-4xl mx-auto mb-12">
            <div>
              ...
              <div className="text-[#FF5722]">Students Engaged</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">500+</div>
              <div className="text-[#FF5722]">Free Resources</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">50+</div>
              <div className="text-[#FF5722]">Schools Partnered</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">95%</div>
              <div className="text-[#FF5722]">Student Satisfaction</div>
            </div>
          </div>

          <Link href="/login">
            <Button size="lg" className="bg-white text-[#0A2559] hover:bg-gray-100 text-lg px-8 py-4">
      ...
      {/* Footer */}
      <footer className="bg-[#0A2559] text-white py-12">
        <div className="container mx-auto px-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <div className="flex flex-col">
                  <span className="text-lg font-bold leading-tight">STEM Spark</span>
                  <span className="text-sm font-semibold text-[#FF5722] leading-tight">Academy</span>
                </div>
              </div>
